            ...
            <div className="container">
                <div className="flex flex-wrap gap-7">
                    ...
                    <div className="lg:w-[35%] w-full">
                        <div className="mb-5 h-full w-full md:py-14 md:px-12 py-10 px-6 rounded-lg" style={useBackgroundImage('https://demo4.drfuri.com/farmart2/wp-content/uploads/sites/11/2021/05/homepage-new-content-bg-2.png', { backgroundPosition: 'bottom center', backgroundColor: '#e4eaee', backgroundSize: 'unset' })}>
                            <div className="flex flex-col text-center">
                                ...
                                <img src="https://i0.wp.com/demo4.drfuri.com/farmart2/wp-content/uploads/sites/11/2021/05/app-while-img.png" alt="" loading="lazy" className="object-contain w-64 mx-auto mt-10" />
                            </div>
                        </div>
                    </div>
                </div>
